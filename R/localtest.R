...
#'@description \code{localtest} can be used to test the equality of the
...
#' estimated curves \eqn{\hat m_l} with \eqn{l = 1, \ldots , M}. Needless to say, 
#' since \eqn{\hat D} is only an estimate of the true D, the sampling 
